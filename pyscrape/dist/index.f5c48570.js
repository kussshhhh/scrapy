...
var _nodeFetch = require("node-fetch"); // Experimental (Node.js 18+)
async function fetchData() {
    try {
        const response = await (0, _nodeFetch.fetch)("/median-data"); // Adjust URL based on your server setup
...
},{"chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","node-fetch":"biJx9"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
